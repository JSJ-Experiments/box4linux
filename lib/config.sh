...
load_config() {
  ...
  if ! config_detect_file; then
    ...
    export BOX_UPDATER_KERNEL_URL BOX_UPDATER_KERNEL_FILE BOX_UPDATER_KERNEL_CHECKSUM BOX_UPDATER_KERNEL_CHECKSUM_FILE BOX_UPDATER_KERNEL_TARGET
    ...
    export BOX_UPDATER_GEO_URL BOX_UPDATER_GEO_FILE BOX_UPDATER_GEO_CHECKSUM BOX_UPDATER_GEO_CHECKSUM_FILE BOX_UPDATER_GEO_TARGET
